...
const Dialogs = (props) => {
  const dialogs = props.dialogsData.map((dialog, i) => {
    return <Dialog name={dialog.name} message={dialog.message} time={dialog.time} link={dialog.link} image={dialog.image} key={i} />;
  });
        ...
        <div  className="row">
          ...
          <div className="col-md-7">
            ...
            <div className="tab-content scrollbar-wrapper wrapper scrollbar-outer">
              ...
              <Route path="/dialogs/contact-2">
                <div className="tab-pane active" id="contact-2">
                  <div className="chat-body">
                    <ul className="chat-message">
                      <li className="left">
              ...
              <Route path="/dialogs/contact-3">
                <div className="tab-pane active" id="contact-3">
                  <div className="chat-body">
                    <ul className="chat-message">
                      <li className="right">
                        <img src="images/users/user-1.jpg" alt="" className="profile-photo-sm pull-right" />
              ...
              <Route path="/dialogs/contact-4">
                <div className="tab-pane active" id="contact-4">
                  <div className="chat-body">
                    <ul className="chat-message">
                      <li className="left">
              ...
              <Route path="/dialogs/contact-5">
                <div className="tab-pane active" id="contact-5">
                  <div className="chat-body">
                    <ul className="chat-message">
                      <li className="left">
              ...
              <Route path="/dialogs/contact-6">
                <div className="tab-pane active" id="contact-6">
                  <div className="chat-body">
                    <ul className="chat-message">
                      <li className="left">
            ...
            <div className="send-message">
              <div className="input-group">
                <input ref={message} type="text" className="form-control" placeholder="Type your message" />
